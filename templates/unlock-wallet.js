...
window["templates"]["unlock-wallet"] = `
<div class="panel">
    ...
    <div class="column col-12 col-sm-12">
        <form class="form-horizontal" action="#forms">
            ...
            <div class="form-group {{hasErrorPincode}}">
                <div class="col-12 col-sm-12">
                    <input class="form-input" id="unlock-wallet-pincode" type="password" placeholder="Pincode" value = "{{pincode}}">
  ...
  <div class="panel-footer internal-panel-footer">
    <div class="column col-12 text-center">
        <button class="btn btn-primary" id="unlockWallet" data-identificatorID = "{{walletID}}">Unlock Wallet</button>
